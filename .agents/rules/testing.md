...
- **Boundary Mocking:** Mock external network boundaries, hardware I/O, and non-deterministic clock/system interfaces. Never mock internal business logic or transform tests into meaningless mock-chains.

...
KIS_DATA_APP_KEY = settings.KIS_DATA_APP_KEY
KIS_DATA_APP_SECRET = settings.KIS_DATA_APP_SECRET
KIS_DATA_HTS_ID = settings.KIS_DATA_HTS_ID
KIS_DATA_API_CONFIG = settings.KIS_DATA_API_CONFIG
